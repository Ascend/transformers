...
#训练模型名称，该参数可外部传入，默认为 openai/whisper-small
Network="whisper-small"
...
nohup python3 -m torch.distributed.launch --nproc_per_node 8 run_speech_recognition_seq2seq.py \
