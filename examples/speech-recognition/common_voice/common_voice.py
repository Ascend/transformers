...
_DATA_URL = "https://voice-prod-bundler-ee1969a6ce8178826482b88e843c335139bd3fb4.s3.amazonaws.com/" \
            "cv-corpus-6.1-2020-12-11/{}.tar.gz"
...
class CommonVoiceConfig(datasets.BuilderConfig):
    ...
    def __init__(self, name, sub_version, **kwargs):
        ...
        description = f"Common Voice speech to text dataset in {self.language} version {self.sub_version} " \
                      f"of {self.date_of_snapshot}. The dataset comprises {self.validated_hr_total} of " \
                      f"validated transcribed speech data from {self.num_of_voice} speakers. The dataset has " \
                      f"a size of {self.size}"
