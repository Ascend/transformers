...
class MobileViTModelIntegrationTest(unittest.TestCase):
    ...
    def default_image_processor(self):
        return MobileViTImageProcessor.from_pretrained(MODEL_NAME_OR_PATH) if is_vision_available() else None


    def test_inference_image_classification_head(self):
        model = MobileViTForImageClassification.from_pretrained(MODEL_NAME_OR_PATH).to(torch_device)
...
if __name__=='__main__':
    unittest.main(argv=['', 'MobileViTModelIntegrationTest.test_inference_image_classification_head'])
