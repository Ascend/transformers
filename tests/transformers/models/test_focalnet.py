...
MODEL_NAME_OR_PATH = "microsoft/focalnet-tiny"
...
class FocalNetModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_image_classification_head(self):
        ...
        model = FocalNetForImageClassification.from_pretrained(MODEL_NAME_OR_PATH).to(torch_device)
...
if __name__=='__main__':
    unittest.main(argv=['', 'FocalNetModelIntegrationTest.test_inference_image_classification_head'])
