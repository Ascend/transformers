...
""" Testing suite for the P_Tuning of Peft. """
...
class TrainingArguments:
    ...
    learning_rate: Optional[float] = field(default=1e-3, metadata={"help": "Learning rate for training."})
...
class PeftConfigsArguments:
    ...
    encoder_hidden_size: Optional[int] = field(default=128, metadata={"help": "The hidden size of the prompt encoder."})
...
def main():
    ...
    peft_config = PromptEncoderConfig(
        ...
        encoder_hidden_size=peft_config_args.encoder_hidden_size
    )
