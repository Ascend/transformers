...
""" Testing suite for the Lora of Peft. """
...
class TrainingArguments:
    ...
    learning_rate: Optional[float] = field(default=3e-4, metadata={"help": "Learning rate for training."})
...
class PeftConfigsArguments:
    ...
    inference_mode: Optional[bool] = field(default=False, metadata={"help": "inference mode for peft config."})
    rank: Optional[int] = field(default=8, metadata={"help": "Lora attention dimension."})
...
def main():
    ...
    peft_config = LoraConfig(
        ...
        inference_mode=peft_config_args.inference_mode,
        r=peft_config_args.rank,
        lora_alpha=peft_config_args.lora_alpha,
        lora_dropout=peft_config_args.lora_dropout,
    )
